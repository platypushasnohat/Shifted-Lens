package com.platypushasnohat.shifted_lens.client.models.armor;
...
public class WhirlicapModel extends HumanoidModel<LivingEntity> {
	...
	public static LayerDefinition createArmorLayer() {
		...
		PartDefinition whirligig = whirlicap.addOrReplaceChild("whirligig", CubeListBuilder.create().texOffs(25, 32).addBox(-6.5F, -6.0F, -6.5F, 13.0F, 0.0F, 13.0F, new CubeDeformation(0.005F))
				...
				.texOffs(47, 57).addBox(0.0F, -6.0F, -1.0F, 0.0F, 5.0F, 2.0F, new CubeDeformation(0.005F)), PartPose.offset(0.0F, -7.0F, 0.0F));
	...
	public WhirlicapModel withAnimations(LivingEntity entity) {
		...
		float rotation = entity.isCrouching() ? (entity.level().isThundering() ? 0.25F : entity.level().isRaining() ? 0.1F : 0.05F) : (entity.level().isThundering() ? 0.5F : entity.level().isRaining() ? 0.2F : 0.1F);
