...
@OnlyIn(Dist.CLIENT)
public class SLGhastGlowLayer extends RenderLayer<Ghast, SLGhastModel> {
    ...
    public SLGhastGlowLayer(RenderLayerParent<Ghast, SLGhastModel> parent) {
        super(parent);
    }

    @Override
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, Ghast entity, float f, float g, float h, float j, float k, float l) {
