...
public class ShiftedEntities {
    ...
    public static final RegistryObject<EntityType<ShiftedGhast>> SHIFTED_GHAST = ENTITY_TYPES.register(
            "ghast", () ->
            EntityType.Builder.of(ShiftedGhast::new, MobCategory.MONSTER)
                    .sized(4.0F, 4.0F)
